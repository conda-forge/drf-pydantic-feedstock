...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/drf-pydantic-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/drf-pydantic-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add drf-pydantic
# for installing globally
pixi global install drf-pydantic
```
...
It is possible to list all of the versions of `drf-pydantic` available on your platform:
...
```
pixi search drf-pydantic --channel conda-forge
```
